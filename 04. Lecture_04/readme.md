### **Master Prompt: Creating Comprehensive Class 9 PHYSICS Notes**
...
TOPICS ARE:
GRADIEND DECENT 
BATCH GRADIEND DECENT 
STOCHASTIC GRADIENT DECENT 

LINEAR REGRESSION WITH MULTIPLE VARIABLE 
LINEAR REGRESSION WITH NORMAL EQUATION 
LINEAR REGRESSION WITH MULTIPLE VARIABLE PSEUDO CODE
LINEAR REGRESSION WITH MULTIPLE VARIABLE PYTHON CODE
LINEAR REGRESSION WITH MULTIPLE VARIABLE BUILT IN LIBRARIES SK LEARN

FEATURE SCALING
MEAN NORALIZATION 
LEARNING RATE (DEBUBBING GRADIENT DECENT)

POLYNOMIAL REGRESSION 
UNDERFITTING AND OVERFITTING 
BIAS _ VARIENCE TRADE OFF
...
LOGISTIC REGRESSION BUILT IN LIBRARIES SK LEARN 
...
**Important:** CREATE OR FORMAT CONTENT FOR GITHUB README.MD FILE
